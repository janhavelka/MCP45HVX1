...
- Resistor options: 5 kOhm, 10 kOhm, 50 kOhm, 100 kOhm (nominal RAB end-to-end resistance)
...
- Operating temperature: -40 degC to +125 degC (Automotive E-temp grade)
- Packages: TSSOP-14 (14-lead) and VQFN-20 (5 mm x 5 mm, 20-lead with exposed thermal pad)
...
MCP4 5 HV X 1 - XXX / ST
 ...
 |   | |  | |   Resistance: 502 = 5kOhm, 103 = 10kOhm, 503 = 50kOhm, 104 = 100kOhm
...
**Examples:**
- `MCP45HV31-503E/ST` - 7-bit, 50 kOhm, E-temp grade, TSSOP-14
- `MCP45HV51-104E/MQ` - 8-bit, 100 kOhm, E-temp grade, VQFN-20
...
MCP4 5 HV X 1 - XXX E / ST  V A O
                              |   |
                              |   Class: O = AEC-Q100 Grade 0 (-40 degC to +150 degC)
                                         [Note: operating junction temp still -40 degC to +125 degC per spec]
...
| Package Code | Package Type | Lead Count | Die Pad | Thermal Resistance thetaJA |
|---|---|---|---|---|
| ST | TSSOP-14 | 14 | No exposed pad | 100  degC/W |
| MQ | VQFN-20 | 20 (5 mm x 5 mm) | Exposed pad (EP, pin 21) | 36.1  degC/W |
...
- The exposed pad significantly improves thermal performance (thetaJA = 36.1  degC/W vs 100  degC/W for TSSOP-14).
...
| Operating temperature | -40 degC to +125 degC | Junction temperature | DS20005304B, p.4 |
