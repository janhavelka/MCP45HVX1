...
**Raw extract:** `docs/pdf-extracted-md/MCP45HVX1-Data-Sheet-DS20005304.md`, pages 28-38
...
All registers are 8 bits wide. The I2C read protocol returns them as 2 bytes (MSB = 0x00, LSB = actual value) for compatibility with the MCP44XX/MCP45XX/MCP46XX families. [Source: DS20005304B, p. 57]
...
|---|---|---|---|
| -502 | 5 kOhm | 8-bit | 7Fh |
| -502 | 5 kOhm | 7-bit | 3Fh |
| -103 | 10 kOhm | 8-bit | 7Fh |
| -103 | 10 kOhm | 7-bit | 3Fh |
| -503 | 50 kOhm | 8-bit | 7Fh |
| -503 | 50 kOhm | 7-bit | 3Fh |
| -104 | 100 kOhm | 8-bit | 7Fh |
| -104 | 100 kOhm | 7-bit | 3Fh |
...
| 80h | 128 | 1 step above mid (8-bit) | > 12 RAB | < 12 RAB |
| 7Fh | 127 | Mid Scale (8-bit) / Full Scale (7-bit) |  12 RAB |  12 RAB |
| 40h | 64 | 1 step above mid (7-bit) | > 12 RAB | < 12 RAB |
| 3Fh | 63 | Mid Scale (7-bit) |  12 RAB |  12 RAB |
