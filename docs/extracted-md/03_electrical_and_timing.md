...
> Warning Stresses above those listed may cause permanent damage to the device. Functional operation at these conditions is not implied.
...
| Max continuous current into P0A, P0W, P0B (-502, 5 kOhm) | - | +/-25 | mA |
| Max continuous current into P0A, P0W, P0B (-103, 10 kOhm) | - | +/-12.5 | mA |
| Max continuous current into P0A, P0W, P0B (-503, 50 kOhm) | - | +/-6.5 | mA |
| Max continuous current into P0A, P0W, P0B (-104, 100 kOhm) | - | +/-6.5 | mA |
| Max output current sunk by any output pin | - | 25 | mA |
| Max output current sourced by any output pin | - | 25 | mA |
| Package power dissipation (TA = +50 degC, TJ = +150 degC) - TSSOP-14 | - | 1000 | mW |
| Package power dissipation (TA = +50 degC, TJ = +150 degC) - VQFN-20 | - | 2800 | mW |
| Soldering temperature of leads (10 s) | - | +300 |  degC |
| ESD (HBM) all pins | - | +/-5 | kV |
| ESD (MM) all pins | - | +/-400 | V |
| Maximum junction temperature TJ | - | 150 |  degC |
...
> Standard Operating Conditions: TA = -40 degC to +125 degC; V+ = 10V to 36V (ref V-) or +/-5V to +/-18V; VL = +2.7V to 5.5V; Typical values at VL = 5.5V, TA = +25 degC.
...
| Delay after device exits Reset state (VL > VBOR) | TBORD | - | 10 | 20 | us | - |
...
| Parameter | Symbol | Min | Typ | Max | Units | Conditions |
|---|---|---|---|---|---|---|
| Digital supply current (serial interface active) | IDDD | - | 45 | 650 | uA | Serial interface active, write 0s to Wiper 0 (addr 00h), VL = 5.5V, FSCL = 3.4 MHz, V- = DGND |
| Digital supply current (serial interface inactive) | IDDD | - | 4 | 7 | uA | Serial interface inactive, VL = 5.5V, SCL = VIH, Wiper = 0, V- = DGND |
| Analog supply current | IDDA | - | - | 5 | uA | V+ to V-; P0A = P0B = P0W; DGND = V- + (V+/2) |
...
|---|---|---|---|---|---|---|
| -502 (5 kOhm) | RAB | 4.0 | 5 | 6.0 | kOhm | V+/V- = 10V to 36V (Note 8) |
| -103 (10 kOhm) | RAB | 8.0 | 10 | 12.0 | kOhm | - |
| -503 (50 kOhm) | RAB | 40.0 | 50 | 60.0 | kOhm | - |
| -104 (100 kOhm) | RAB | 80.0 | 100 | 120.0 | kOhm | - |
...
|---|---|---|---|
| -502 (5 kOhm) | 9.00 | mA | 36V / RAB(MIN); V- = -18V, V+ = +18V |
| -103 (10 kOhm) | 4.50 | mA | - |
| -503 (50 kOhm) | 0.90 | mA | - |
| -104 (100 kOhm) | 0.45 | mA | - |
...
| Step Resistance (8-bit simplified) | RS | RAB / 255 | Ohm | By design (Note 1) |
| Step Resistance (7-bit simplified) | RS | RAB / 127 | Ohm | By design (Note 1) |

### 4.4 Wiper Resistance

| Conditions | Symbol | Typ | Max | Units |
|---|---|---|---|---|
| IW = 1 mA; V+ = +18V; V- = -18V; code = 00h; P0A floating; P0B = V- | RW | 75 | 170 | Ohm |
| IW = 1 mA; V+ = +5.0V; V- = -5.0V; code = 00h; P0A floating; P0B = V- | RW | 145 | 200 | Ohm |

**Note (+/-5V condition):** Not tested; specified by characterization. [Source: DS20005304B, p.6]

**Note on RW variability:** Wiper resistance depends on V+/V- voltage, terminal voltages, wiper code, RAB resistance, and temperature. At higher temperatures (+125 degC) and larger RAB (50 kOhm, 100 kOhm), analog switch leakage causes increased RW. [Source: DS20005304B, p.41]

### 4.5 Temperature Coefficients

| Parameter | Symbol | Typ | Units | Conditions |
|---|---|---|---|---|
| Nominal Resistance Tempco (RAB) | RAB/T | 50 | ppm/ degC | TA = -40 degC to +85 degC |
| Nominal Resistance Tempco (RAB) | RAB/T | 100 | ppm/ degC | TA = -40 degC to +125 degC |
| Ratiometric Tempco | VBW/T | 15 | ppm/ degC | Code = mid-scale (7Fh or 3Fh) |
...
| Max Terminal Current (-502, 5 kOhm) | IT, IW | - | 25 | mA | IBW (W != ZS) and IAW (W != FS) |
| Max Terminal Current (-103, 10 kOhm) | IT, IW | - | 12.5 | mA | - |
| Max Terminal Current (-503, 50 kOhm) | IT, IW | - | 6.5 | mA | - |
| Max Terminal Current (-104, 100 kOhm) | IT, IW | - | 6.5 | mA | - |
...
|---|---|---|---|---|
| 5 kOhm | 8-bit | -10.5 | LSb | VAB = 20V to 36V |
| 5 kOhm | 8-bit | -8.5 | LSb | VAB = 20V to 36V; -40 degC <= TA <= +85 degC (Note 2) |
| 5 kOhm | 8-bit | -14.0 | LSb | VAB = 10V to 36V |
| 5 kOhm | 7-bit | -5.5 | LSb | VAB = 20V to 36V |
| 5 kOhm | 7-bit | -4.5 | LSb | VAB = 20V to 36V; -40 degC <= TA <= +85 degC (Note 2) |
| 5 kOhm | 7-bit | -7.5 | LSb | VAB = 10V to 36V |
| 10 kOhm | 8-bit | -4.5 | LSb | VAB = 20V to 36V |
| 10 kOhm | 8-bit | -6.0 | LSb | VAB = 10V to 36V |
| 10 kOhm | 7-bit | -2.65 | LSb | VAB = 20V to 36V |
| 10 kOhm | 7-bit | -2.25 | LSb | VAB = 20V to 36V; -40 degC <= TA <= +85 degC (Note 2) |
| 10 kOhm | 7-bit | -3.5 | LSb | VAB = 10V to 36V |
| 50 kOhm | 8-bit | -1.0 | LSb | VAB = 20V to 36V |
| 50 kOhm | 8-bit | -1.4 | LSb | VAB = 10V to 36V |
| 50 kOhm | 7-bit | -1.0 | LSb | VAB = 20V to 36V |
| 50 kOhm | 7-bit | -1.2 | LSb | VAB = 10V to 36V |
| 100 kOhm | 8-bit | -0.7 | LSb | VAB = 20V to 36V |
| 100 kOhm | 8-bit | -0.95 | LSb | VAB = 10V to 36V |
| 100 kOhm | 7-bit | -0.85 | LSb | VAB = 20V to 36V |
| 100 kOhm | 7-bit | -0.975 | LSb | VAB = 10V to 36V |
...
|---|---|---|---|---|
| 5 kOhm | 8-bit | +9.5 | LSb | VAB = 20V to 36V |
| 5 kOhm | 8-bit | +8.5 | LSb | VAB = 20V to 36V; -40 degC <= TA <= +85 degC (Note 2) |
| 5 kOhm | 8-bit | +14.5 | LSb | VAB = 10V to 36V |
| 5 kOhm | 7-bit | +4.5 | LSb | VAB = 20V to 36V |
| 5 kOhm | 7-bit | +7.0 | LSb | VAB = 10V to 36V |
| 10 kOhm | 8-bit | +4.25 | LSb | VAB = 20V to 36V |
| 10 kOhm | 8-bit | +6.5 | LSb | VAB = 10V to 36V |
| 10 kOhm | 7-bit | +2.125 | LSb | VAB = 20V to 36V |
| 10 kOhm | 7-bit | +3.25 | LSb | VAB = 10V to 36V |
| 50 kOhm | 8-bit | +0.9 | LSb | VAB = 20V to 36V |
| 50 kOhm | 8-bit | +1.3 | LSb | VAB = 10V to 36V |
| 50 kOhm | 7-bit | +0.5 | LSb | VAB = 20V to 36V |
| 50 kOhm | 7-bit | +0.7 | LSb | VAB = 10V to 36V |
| 100 kOhm | 8-bit | +0.6 | LSb | VAB = 20V to 36V |
| 100 kOhm | 8-bit | +0.95 | LSb | VAB = 10V to 36V |
| 100 kOhm | 7-bit | +0.3 | LSb | VAB = 20V to 36V |
| 100 kOhm | 7-bit | +0.475 | LSb | VAB = 10V to 36V |
...
|---|---|---|---|---|---|---|
| 5 kOhm | 8-bit | -1 | +/-0.5 | +1 | LSb | VAB = 10V to 36V |
| 5 kOhm | 7-bit | -0.5 | +/-0.25 | +0.5 | LSb | VAB = 10V to 36V |
| 10 kOhm | 8-bit | -1 | +/-0.5 | +1 | LSb | VAB = 10V to 36V |
| 10 kOhm | 7-bit | -0.5 | +/-0.25 | +0.5 | LSb | VAB = 10V to 36V |
| 50 kOhm | 8-bit | -1.1 | +/-0.5 | +1.1 | LSb | VAB = 10V to 36V |
| 50 kOhm | 8-bit | -1 | +/-0.5 | +1 | LSb | VAB = 20V to 36V (Note 2) |
| 50 kOhm | 7-bit | -0.6 | +/-0.25 | +0.6 | LSb | VAB = 10V to 36V |
| 100 kOhm | 8-bit | -1.85 | +/-0.5 | +1.85 | LSb | VAB = 10V to 36V |
| 100 kOhm | 8-bit | -1.2 | +/-0.5 | +1.2 | LSb | VAB = 20V to 36V (Note 2) |
| 100 kOhm | 7-bit | -1 | +/-0.5 | +1 | LSb | VAB = 10V to 36V |
...
| Device | Resolution | Min | Typ | Max | Units | Conditions |
|---|---|---|---|---|---|---|
| 5 kOhm | 8-bit | -0.7 | +/-0.25 | +0.7 | LSb | VAB = 10V to 36V |
| 5 kOhm | 7-bit | -0.25 | +/-0.125 | +0.25 | LSb | VAB = 10V to 36V |
| 10 kOhm | 8-bit | -0.375 | +/-0.125 | +0.375 | LSb | VAB = 10V to 36V |
| 10 kOhm | 7-bit | -0.25 | +/-0.1 | +0.25 | LSb | VAB = 10V to 36V |
| 50 kOhm | 8-bit | -0.25 | +/-0.125 | +0.25 | LSb | VAB = 10V to 36V |
| 50 kOhm | 7-bit | -0.125 | +/-0.1 | +0.125 | LSb | VAB = 10V to 36V |
| 100 kOhm | 8-bit | -0.25 | +/-0.125 | +0.25 | LSb | VAB = 10V to 36V |
| 100 kOhm | 7-bit | -0.125 | +/-0.1 | +0.125 | LSb | VAB = 10V to 36V |
...
|---|---|---|---|---|---|
| 5 kOhm | 8-bit | -2.0 | +2.0 | LSb | IW = 6.0 mA; (V+ - V-) = 36V (Note 2) |
| 5 kOhm | 8-bit | -2.5 | +2.5 | LSb | IW = 3.3 mA; 20V (Note 2) |
| 5 kOhm | 8-bit | -4.5 | +4.5 | LSb | IW = 1.7 mA; 10V |
| 5 kOhm | 7-bit | -1.0 | +1.0 | LSb | IW = 6.0 mA; 36V (Note 2) |
| 5 kOhm | 7-bit | -1.5 | +1.5 | LSb | IW = 3.3 mA; 20V (Note 2) |
| 5 kOhm | 7-bit | -2.0 | +2.0 | LSb | IW = 1.7 mA; 10V |
| 10 kOhm | 8-bit | -1.2 | +1.2 | LSb | IW = 3.0 mA; 36V (Note 2) |
| 10 kOhm | 8-bit | -1.75 | +1.75 | LSb | IW = 1.7 mA; 20V (Note 2) |
| 10 kOhm | 8-bit | -2.0 | +2.0 | LSb | IW = 830 uA; 10V |
| 10 kOhm | 7-bit | -0.6 | +0.6 | LSb | IW = 3.0 mA; 36V (Note 2) |
| 10 kOhm | 7-bit | -0.8 | +0.8 | LSb | IW = 1.7 mA; 20V (Note 2) |
| 10 kOhm | 7-bit | -1.1 | +1.1 | LSb | IW = 830 uA; 10V |
| 50 kOhm | 8-bit | -1.0 | +1.0 | LSb | IW = 600 uA; 36V (Note 2) |
| 50 kOhm | 8-bit | -1.0 | +1.0 | LSb | IW = 330 uA; 20V (Note 2) |
| 50 kOhm | 8-bit | -1.2 | +1.2 | LSb | IW = 170 uA; 10V |
| 50 kOhm | 7-bit | -0.5 | +0.5 | LSb | IW = 600 uA; 36V (Note 2) |
| 50 kOhm | 7-bit | -0.5 | +0.5 | LSb | IW = 330 uA; 20V (Note 2) |
| 50 kOhm | 7-bit | -0.6 | +0.6 | LSb | IW = 170 uA; 10V |
| 100 kOhm | 8-bit | -1.0 | +1.0 | LSb | IW = 300 uA; 36V (Note 2) |
| 100 kOhm | 8-bit | -1.0 | +1.0 | LSb | IW = 170 uA; 20V (Note 2) |
| 100 kOhm | 8-bit | -1.2 | +1.2 | LSb | IW = 83 uA; 10V |
| 100 kOhm | 7-bit | -0.5 | +0.5 | LSb | IW = 300 uA; 36V (Note 2) |
| 100 kOhm | 7-bit | -0.5 | +0.5 | LSb | IW = 170 uA; 20V (Note 2) |
| 100 kOhm | 7-bit | -0.6 | +0.6 | LSb | IW = 83 uA; 10V |
...
| Device | Resolution | Min | Max | Units | Conditions |
|---|---|---|---|---|---|
| 5 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 6.0 mA; 36V (Note 2) |
| 5 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 3.3 mA; 20V (Note 2) |
| 5 kOhm | 8-bit | -0.8 | +0.8 | LSb | IW = 1.7 mA; 10V |
| 5 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 6.0 mA; 36V (Note 2) |
| 5 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 3.3 mA; 20V (Note 2) |
| 5 kOhm | 7-bit | -0.4 | +0.4 | LSb | IW = 1.7 mA; 10V |
| 10 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 3.0 mA; 36V (Note 2) |
| 10 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 1.7 mA; 20V (Note 2) |
| 10 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 830 uA; 10V |
| 10 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 3.0 mA; 36V (Note 2) |
| 10 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 1.7 mA; 20V (Note 2) |
| 10 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 830 uA; 10V |
| 50 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 600 uA; 36V (Note 2) |
| 50 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 330 uA; 20V (Note 2) |
| 50 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 170 uA; 10V |
| 50 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 600 uA; 36V (Note 2) |
| 50 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 330 uA; 20V (Note 2) |
| 50 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 170 uA; 10V |
| 100 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 300 uA; 36V (Note 2) |
| 100 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 170 uA; 20V (Note 2) |
| 100 kOhm | 8-bit | -0.5 | +0.5 | LSb | IW = 83 uA; 10V |
| 100 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 300 uA; 36V (Note 2) |
| 100 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 170 uA; 20V (Note 2) |
| 100 kOhm | 7-bit | -0.25 | +0.25 | LSb | IW = 83 uA; 10V |
...
> Standard Operating Conditions: TA = -40 degC to +125 degC; VL = 2.7V to 5.5V.
...
| Parameter | Symbol | Min | Max | Units | Conditions |
|---|---|---|---|---|---|
| Schmitt Trigger High-Input Threshold | VIH | 0.7 x VL | VL + 0.3 | V | 1.8 V <= VL <= 5.5 V |
| Schmitt Trigger Low-Input Threshold | VIL | DGND - 0.5 | 0.3 x VL | V | - |
| Hysteresis of Schmitt Trigger Inputs | VHYS | 0.1 x VL | - | V | - |
| Output Low Voltage (SDA only) | VOL | DGND | 0.2 x VL | V | VL = 5.5 V; IOL = 5 mA |
| Output Low Voltage (SDA only) | VOL | DGND | 0.2 x VL | V | VL = 1.8 V; IOL = 800 uA |
| Input Leakage Current | IIL | -1 | +1 | uA | VIN = VL and VIN = DGND |

> SDA is the only digital output pin. All other digital signals (SCL, A0, A1, SHDN, WLAT) are input-only. The 0.2 x VL formula means VOL scales with VL; at VL = 5.5 V this gives 1.1 V max VOL (at 5 mA), at VL = 1.8 V this gives 0.36 V max VOL (at 800 uA). [Source: DS20005304B, p. 13]
...
|---|---|---|---|---|
| 5 kOhm | 8-bit | 480 | kHz | 7Fh |
| 5 kOhm | 7-bit | 480 | kHz | 3Fh |
| 10 kOhm | 8-bit | 240 | kHz | 7Fh |
| 10 kOhm | 7-bit | 240 | kHz | 3Fh |
| 50 kOhm | 8-bit | 48 | kHz | 7Fh |
| 50 kOhm | 7-bit | 48 | kHz | 3Fh |
| 100 kOhm | 8-bit | 24 | kHz | 7Fh |
| 100 kOhm | 7-bit | 24 | kHz | 3Fh |
...
> Formula: PDISS = (IDDD x 5.5V) + (IDDA x 36V) + (IAB x 36V) [Note 15]
...
> I2C AC Characteristics: TA = -40 degC to +125 degC; 2.7V <= VL <= 5.5V; DGND = V- (Note 1)
...
| 96 | TWLATL | WLAT High or Low Time | - | 2 | - | us (min) |
...
> I2C AC Characteristics: TA = -40 degC to +125 degC; 2.7V <= VL <= 5.5V; DGND = V-.
...
|---|---|---|---|---|
| Specified Temperature Range | TA | -40 | +125 |  degC |
| Operating Temperature Range | TA | -40 | +125 |  degC |
| Storage Temperature Range | TA | -65 | +150 |  degC |

### 11.1 Thermal Package Resistances

| Package | thetaJA | Units |
|---|---|---|
| 14L-TSSOP (ST) | 100 |  degC/W |
| 20L-VQFN-5x5 (MQ) | 36.1 |  degC/W |
...
Raw text is now available in `docs/pdf-extracted-md/MCP45HVX1_Typical_Performance_Curves_DS20005307A.md` from `MCP45HVX1_Typical_Performance_Curves_DS20005307A.pdf`. The source is graph-heavy, so numerical curve interpretation still requires direct PDF review rather than relying on the raw text extraction alone.
