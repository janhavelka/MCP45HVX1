...
Current status: pre-production software-hardening branch. Hardware validation,
high-voltage behavior, analog accuracy, General Call safety, and release
approval remain evidence-gated.
