...
## CLI Wiper Presets And Migration

Both diagnostic CLIs write these exact register codes. All three commands
change the analog output and reject trailing arguments.

| Resolution | `zero` | `mid` (POR midpoint) | `max` |
|---|---:|---:|---:|
