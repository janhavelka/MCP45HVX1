...
class HilRun:
    ...
    def report_text(self, summary: dict[str, Any]) -> str:
        ...
        lines = [
            ...
            "- Build, upload, and repository validation commands are recorded separately from this HIL evidence bundle.",
            "",
            "## Summary",
            "",
            "| Result | Count |",
        ...
        lines.extend([
            ...
            "",
            "- This runner report captures HIL evidence only; source changes are recorded in version control.",
            "",
            "## Final Verification",
            "",
            "- Final state and health commands are included in the detailed steps when the serial session reached them.",
            "- Repository build and test results are recorded separately from this HIL evidence bundle.",
            "",
            "## Claims Supported",
            "",
